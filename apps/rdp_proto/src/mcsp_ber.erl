...
decode(Type,Data0) ->
try begin {Data,Rest0} = ber_decode_nif(Data0), {decode_disp(Type, Data),Rest0} end of
  {Result,Rest} ->
    {ok,Result,Rest}
  catch
    Class:Exception when Class =:= error; Class =:= exit ->
...
%%-------------------------------------------------
[V3|Tlv4] = Tlv3,
Term3 = decode_integer(V3,{0,'MAX'},[2]),

%%-------------------------------------------------
%% attribute numPriorities(4) with type INTEGER
%%-------------------------------------------------
[V4|Tlv5] = Tlv4,
Term4 = decode_integer(V4,{0,'MAX'},[2]),

%%-------------------------------------------------
%% attribute minThroughput(5) with type INTEGER
%%-------------------------------------------------
[V5|Tlv6] = Tlv5,
Term5 = decode_integer(V5,{0,'MAX'},[2]),

%%-------------------------------------------------
%% attribute maxHeight(6) with type INTEGER
%%-------------------------------------------------
[V6|Tlv7] = Tlv6,
Term6 = decode_integer(V6,{0,'MAX'},[2]),

%%-------------------------------------------------
%% attribute maxMCSPDUsize(7) with type INTEGER
%%-------------------------------------------------
[V7|Tlv8] = Tlv7,
Term7 = decode_integer(V7,{0,'MAX'},[2]),
