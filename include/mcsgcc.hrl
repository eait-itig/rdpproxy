...
-record(mcs_cr, {data, called=0, max_channels=34, max_users=2, max_tokens=0, num_priorities=1, min_throughput=0, max_height=1, max_size=65535, version=2, mcs_result = 'rt-successful', node=31219, tag=1, result=success}).
...
-record(mcs_data, {user=1001, channel=0, priority=low, data}).
-record(mcs_srv_data, {user=1001, channel=0, priority=low, data}).
