...
-record(tsud_core, {version=[8,4], width, height, sas=16#aa03, kbd_layout=?KBDL_US, client_build=2600, client_name="localhost", kbd_type=?KBD_IBM101, kbd_sub_type=0, kbd_fun_keys=12, color='24bpp', colors=['24bpp'], capabilities=[errinfo], selected=[], conn_type=unknown}).
