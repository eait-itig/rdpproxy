...
decode_integer(Tlv,{1,1000},TagIn).
...
decode_integer(Tlv,{1001,65535},TagIn).
...
decode_integer(Tlv,{1,65535},TagIn).
...
case Val of
notInUse -> encode_enumerated(0, TagIn);
selfGrabbed -> encode_enumerated(1, TagIn);
otherGrabbed -> encode_enumerated(2, TagIn);
selfInhibited -> encode_enumerated(3, TagIn);
otherInhibited -> encode_enumerated(4, TagIn);
selfRecipient -> encode_enumerated(5, TagIn);
selfGiving -> encode_enumerated(6, TagIn);
otherGiving -> encode_enumerated(7, TagIn);
...
decode_enumerated(Tlv,[{notInUse,0},{selfGrabbed,1},{otherGrabbed,2},{selfInhibited,3},{otherInhibited,4},{selfRecipient,5},{selfGiving,6},{otherGiving,7}],TagIn).
...
case Val of
top -> encode_enumerated(0, TagIn);
high -> encode_enumerated(1, TagIn);
medium -> encode_enumerated(2, TagIn);
low -> encode_enumerated(3, TagIn);
Enumval1 -> exit({error,{asn1, {enumerated_not_in_range,Enumval1}}})
end.
...
decode_enumerated(Tlv,[{top,0},{high,1},{medium,2},{low,3}],TagIn).
...
encode_bit_string(2, Val, [{'begin',0},{'end',1}], TagIn).
...
%%-------------------------------------------------
[V1|Tlv2] = Tlv1,
Term1 = decode_integer(V1,{'MIN','MAX'},[2]),

%%-------------------------------------------------
%% attribute maxUserIds(2) with type INTEGER
%%-------------------------------------------------
[V2|Tlv3] = Tlv2,
Term2 = decode_integer(V2,{'MIN','MAX'},[2]),

%%-------------------------------------------------
%% attribute maxTokenIds(3) with type INTEGER
%%-------------------------------------------------
[V3|Tlv4] = Tlv3,
Term3 = decode_integer(V3,{'MIN','MAX'},[2]),

%%-------------------------------------------------
%% attribute numPriorities(4) with type INTEGER
%%-------------------------------------------------
[V4|Tlv5] = Tlv4,
Term4 = decode_integer(V4,{'MIN','MAX'},[2]),

%%-------------------------------------------------
%% attribute minThroughput(5) with type INTEGER
%%-------------------------------------------------
[V5|Tlv6] = Tlv5,
Term5 = decode_integer(V5,{'MIN','MAX'},[2]),

%%-------------------------------------------------
%% attribute maxHeight(6) with type INTEGER
%%-------------------------------------------------
[V6|Tlv7] = Tlv6,
Term6 = decode_integer(V6,{'MIN','MAX'},[2]),

%%-------------------------------------------------
%% attribute maxMCSPDUsize(7) with type INTEGER
%%-------------------------------------------------
[V7|Tlv8] = Tlv7,
Term7 = decode_integer(V7,{'MIN','MAX'},[2]),

%%-------------------------------------------------
%% attribute protocolVersion(8) with type INTEGER
%%-------------------------------------------------
[V8|Tlv9] = Tlv8,
Term8 = decode_integer(V8,{0,'MAX'},[2]),
...
%%-------------------------------------------------
[V7|Tlv8] = Tlv7,
Term7 = decode_restricted_string(V7,[4]),
...
'rt-successful' -> encode_enumerated(0, [<<10>>]);
'rt-domain-merging' -> encode_enumerated(1, [<<10>>]);
'rt-domain-not-hierarchical' -> encode_enumerated(2, [<<10>>]);
'rt-no-such-channel' -> encode_enumerated(3, [<<10>>]);
'rt-no-such-domain' -> encode_enumerated(4, [<<10>>]);
'rt-no-such-user' -> encode_enumerated(5, [<<10>>]);
'rt-not-admitted' -> encode_enumerated(6, [<<10>>]);
'rt-other-user-id' -> encode_enumerated(7, [<<10>>]);
'rt-parameters-unacceptable' -> encode_enumerated(8, [<<10>>]);
'rt-token-not-available' -> encode_enumerated(9, [<<10>>]);
'rt-token-not-possessed' -> encode_enumerated(10, [<<10>>]);
'rt-too-many-channels' -> encode_enumerated(11, [<<10>>]);
'rt-too-many-tokens' -> encode_enumerated(12, [<<10>>]);
'rt-too-many-users' -> encode_enumerated(13, [<<10>>]);
'rt-unspecified-failure' -> encode_enumerated(14, [<<10>>]);
'rt-user-rejected' -> encode_enumerated(15, [<<10>>]);
Enumval1 -> exit({error,{asn1, {enumerated_not_in_range,Enumval1}}})
end,
...
%%-------------------------------------------------
[V2|Tlv3] = Tlv2,
Term2 = decode_integer(V2,{0,'MAX'},[2]),
...
top -> encode_enumerated(0, [<<10>>]);
high -> encode_enumerated(1, [<<10>>]);
medium -> encode_enumerated(2, [<<10>>]);
low -> encode_enumerated(3, [<<10>>]);
...
%%-------------------------------------------------
[V1|Tlv2] = Tlv1,
Term1 = decode_integer(V1,{0,'MAX'},[2]),

%%-------------------------------------------------
%% attribute dataPriority(2) with type ENUMERATED
%%-------------------------------------------------
[V2|Tlv3] = Tlv2,
Term2 = decode_enumerated(V2,[{top,0},{high,1},{medium,2},{low,3}],[10]),
...
%%-------------------------------------------------
[V1|Tlv2] = Tlv1,
Term1 = decode_integer(V1,{1,1000},[2]),
...
%%-------------------------------------------------
[V2|Tlv3] = Tlv2,
Term2 = decode_integer(V2,{1001,65535},[2]),
...
'dec_ChannelAttributes_private_admitted'(Tlv, TagIn) ->
   ...
   %%-------------------------------------------------
Tlv1 = match_tags(Tlv, TagIn),
[decode_integer(V1,{1001,65535},[2]) || V1 <- Tlv1].
...
%%-------------------------------------------------
[V3|Tlv4] = Tlv3,
Term3 = decode_integer(V3,{1001,65535},[2]),
...
%%-------------------------------------------------
[V1|Tlv2] = Tlv1,
Term1 = decode_integer(V1,{1001,65535},[2]),
...
'dec_MergeChannelsRequest_purgeChannelIds'(Tlv, TagIn) ->
   ...
   %%-------------------------------------------------
Tlv1 = match_tags(Tlv, TagIn),
[decode_integer(V1,{0,65535},[2]) || V1 <- Tlv1].
...
%%-------------------------------------------------
[V1|Tlv2] = Tlv1,
Term1 = decode_integer(V1,{1,65535},[2]),
...
'dec_MergeTokensRequest_purgeTokenIds'(Tlv, TagIn) ->
   ...
   %%-------------------------------------------------
Tlv1 = match_tags(Tlv, TagIn),
[decode_integer(V1,{1,65535},[2]) || V1 <- Tlv1].
...
%%-------------------------------------------------
   {EncBytes1,EncLen1} = case Cindex1 of
'rn-domain-disconnected' -> encode_enumerated(0, [<<10>>]);
'rn-provider-initiated' -> encode_enumerated(1, [<<10>>]);
'rn-token-purged' -> encode_enumerated(2, [<<10>>]);
'rn-user-requested' -> encode_enumerated(3, [<<10>>]);
'rn-channel-purged' -> encode_enumerated(4, [<<10>>]);
Enumval1 -> exit({error,{asn1, {enumerated_not_in_range,Enumval1}}})
end,
...
%%-------------------------------------------------
[V1|Tlv2] = Tlv1,
Term1 = decode_enumerated(V1,[{'rn-domain-disconnected',0},{'rn-provider-initiated',1},{'rn-token-purged',2},{'rn-user-requested',3},{'rn-channel-purged',4}],[10]),
...
%%-------------------------------------------------
   {EncBytes1,EncLen1} = case Cindex1 of
'dc-inconsistent-merge' -> encode_enumerated(0, [<<10>>]);
'dc-forbidden-PDU-downward' -> encode_enumerated(1, [<<10>>]);
'dc-forbidden-PDU-upward' -> encode_enumerated(2, [<<10>>]);
'dc-invalid-BER-encoding' -> encode_enumerated(3, [<<10>>]);
'dc-invalid-PER-encoding' -> encode_enumerated(4, [<<10>>]);
'dc-misrouted-user' -> encode_enumerated(5, [<<10>>]);
'dc-unrequested-confirm' -> encode_enumerated(6, [<<10>>]);
'dc-wrong-transport-priority' -> encode_enumerated(7, [<<10>>]);
'dc-channel-id-conflict' -> encode_enumerated(8, [<<10>>]);
'dc-token-id-conflict' -> encode_enumerated(9, [<<10>>]);
'dc-not-user-id-channel' -> encode_enumerated(10, [<<10>>]);
'dc-too-many-channels' -> encode_enumerated(11, [<<10>>]);
'dc-too-many-tokens' -> encode_enumerated(12, [<<10>>]);
'dc-too-many-users' -> encode_enumerated(13, [<<10>>]);
Enumval1 -> exit({error,{asn1, {enumerated_not_in_range,Enumval1}}})
end,
...
%%-------------------------------------------------
[V1|Tlv2] = Tlv1,
Term1 = decode_enumerated(V1,[{'dc-inconsistent-merge',0},{'dc-forbidden-PDU-downward',1},{'dc-forbidden-PDU-upward',2},{'dc-invalid-BER-encoding',3},{'dc-invalid-PER-encoding',4},{'dc-misrouted-user',5},{'dc-unrequested-confirm',6},{'dc-wrong-transport-priority',7},{'dc-channel-id-conflict',8},{'dc-token-id-conflict',9},{'dc-not-user-id-channel',10},{'dc-too-many-channels',11},{'dc-too-many-tokens',12},{'dc-too-many-users',13}],[10]),
...
[{2,V2}|TempTlv3] ->
    {decode_integer(V2,{1001,65535},[]), TempTlv3};
    _ ->
        { asn1_NOVALUE, Tlv2}
end,
...
%%-------------------------------------------------
[V2|Tlv3] = Tlv2,
Term2 = decode_integer(V2,{0,65535},[2]),
...
%%-------------------------------------------------
[V3|Tlv4] = Tlv3,
Term3 = decode_integer(V3,{0,65535},[2]),
...
[{2,V3}|TempTlv4] ->
    {decode_integer(V3,{1001,65535},[]), TempTlv4};
    _ ->
        { asn1_NOVALUE, Tlv3}
end,
...
%%-------------------------------------------------
   {EncBytes4,EncLen4} = encode_bit_string(2, Cindex4, [{'begin',0},{'end',1}], [<<3>>]),
...
%%-------------------------------------------------
[V3|Tlv4] = Tlv3,
Term3 = decode_enumerated(V3,[{top,0},{high,1},{medium,2},{low,3}],[10]),
...
%%-------------------------------------------------
[V5|Tlv6] = Tlv5,
Term5 = decode_restricted_string(V5,[4]),
...
%%-------------------------------------------------
[V2|Tlv3] = Tlv2,
Term2 = decode_integer(V2,{1,65535},[2]),
...
%%-------------------------------------------------
   {EncBytes4,EncLen4} = case Cindex4 of
notInUse -> encode_enumerated(0, [<<10>>]);
selfGrabbed -> encode_enumerated(1, [<<10>>]);
otherGrabbed -> encode_enumerated(2, [<<10>>]);
selfInhibited -> encode_enumerated(3, [<<10>>]);
otherInhibited -> encode_enumerated(4, [<<10>>]);
selfRecipient -> encode_enumerated(5, [<<10>>]);
selfGiving -> encode_enumerated(6, [<<10>>]);
otherGiving -> encode_enumerated(7, [<<10>>]);
...
%%-------------------------------------------------
[V3|Tlv4] = Tlv3,
Term3 = decode_integer(V3,{1,65535},[2]),

%%-------------------------------------------------
%% attribute tokenStatus(4) with type ENUMERATED
%%-------------------------------------------------
[V4|Tlv5] = Tlv4,
Term4 = decode_enumerated(V4,[{notInUse,0},{selfGrabbed,1},{otherGrabbed,2},{selfInhibited,3},{otherInhibited,4},{selfRecipient,5},{selfGiving,6},{otherGiving,7}],[10]),
...
%%-------------------------------------------------
[V3|Tlv4] = Tlv3,
Term3 = decode_enumerated(V3,[{notInUse,0},{selfGrabbed,1},{otherGrabbed,2},{selfInhibited,3},{otherInhibited,4},{selfRecipient,5},{selfGiving,6},{otherGiving,7}],[10]),
...
case Val of
'rn-domain-disconnected' -> encode_enumerated(0, TagIn);
'rn-provider-initiated' -> encode_enumerated(1, TagIn);
'rn-token-purged' -> encode_enumerated(2, TagIn);
'rn-user-requested' -> encode_enumerated(3, TagIn);
'rn-channel-purged' -> encode_enumerated(4, TagIn);
Enumval1 -> exit({error,{asn1, {enumerated_not_in_range,Enumval1}}})
end.
...
decode_enumerated(Tlv,[{'rn-domain-disconnected',0},{'rn-provider-initiated',1},{'rn-token-purged',2},{'rn-user-requested',3},{'rn-channel-purged',4}],TagIn).
...
case Val of
'rt-successful' -> encode_enumerated(0, TagIn);
'rt-domain-merging' -> encode_enumerated(1, TagIn);
'rt-domain-not-hierarchical' -> encode_enumerated(2, TagIn);
'rt-no-such-channel' -> encode_enumerated(3, TagIn);
'rt-no-such-domain' -> encode_enumerated(4, TagIn);
'rt-no-such-user' -> encode_enumerated(5, TagIn);
'rt-not-admitted' -> encode_enumerated(6, TagIn);
'rt-other-user-id' -> encode_enumerated(7, TagIn);
'rt-parameters-unacceptable' -> encode_enumerated(8, TagIn);
'rt-token-not-available' -> encode_enumerated(9, TagIn);
'rt-token-not-possessed' -> encode_enumerated(10, TagIn);
'rt-too-many-channels' -> encode_enumerated(11, TagIn);
'rt-too-many-tokens' -> encode_enumerated(12, TagIn);
'rt-too-many-users' -> encode_enumerated(13, TagIn);
'rt-unspecified-failure' -> encode_enumerated(14, TagIn);
'rt-user-rejected' -> encode_enumerated(15, TagIn);
Enumval1 -> exit({error,{asn1, {enumerated_not_in_range,Enumval1}}})
end.
...
case Val of
'dc-inconsistent-merge' -> encode_enumerated(0, TagIn);
'dc-forbidden-PDU-downward' -> encode_enumerated(1, TagIn);
'dc-forbidden-PDU-upward' -> encode_enumerated(2, TagIn);
'dc-invalid-BER-encoding' -> encode_enumerated(3, TagIn);
'dc-invalid-PER-encoding' -> encode_enumerated(4, TagIn);
'dc-misrouted-user' -> encode_enumerated(5, TagIn);
'dc-unrequested-confirm' -> encode_enumerated(6, TagIn);
'dc-wrong-transport-priority' -> encode_enumerated(7, TagIn);
'dc-channel-id-conflict' -> encode_enumerated(8, TagIn);
'dc-token-id-conflict' -> encode_enumerated(9, TagIn);
'dc-not-user-id-channel' -> encode_enumerated(10, TagIn);
'dc-too-many-channels' -> encode_enumerated(11, TagIn);
'dc-too-many-tokens' -> encode_enumerated(12, TagIn);
'dc-too-many-users' -> encode_enumerated(13, TagIn);
Enumval1 -> exit({error,{asn1, {enumerated_not_in_range,Enumval1}}})
end.
...
range_check_integer(Int, {'MIN', 'MAX'}) ->
    Int;
range_check_integer(Int, {'MIN', Ub}) when Int =< Ub ->
    Int;
